...
Route::group(["namespace" => "Whtht\IntroStep\Controllers"], function () {
    Route::group(["prefix" => "intro-step-admin", "middleware" => config('intro-step.web_middleware')], function() {
        Route::get("/", "IntroStepController@index");
    });



    Route::group(["namespace" => "Api","prefix" => "intro-step-admin/api", "middleware" => config('intro-step.api_middleware')], function() {
